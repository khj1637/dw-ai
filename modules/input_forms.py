...
def render_defect_form(sheet_name, worksheet_name):
    ...
    with st.form(key="defect_form"):
        ...
        submitted = st.form_submit_button("하자사례 저장", key="defect_submit")
        if submitted:
...
def render_ve_form(sheet_name, worksheet_name):
    ...
    with st.form(key="ve_form"):
        ...
        submitted = st.form_submit_button("VE사례 저장", key="ve_submit")
        if submitted:
...
def render_duration_form(sheet_name, worksheet_name):
    ...
    with st.form(key="duration_form"):
        ...
        total_floor_area = st.number_input("연면적 (㎡)", min_value=0.0, key="duration_total_area")
        ...
        duration = st.number_input("전체 공사기간 (일)", min_value=0, step=1, key="duration_days")

        submitted = st.form_submit_button("공사기간 저장", key="duration_submit")
        if submitted:
...
def render_etc_form(sheet_name, worksheet_name):
    ...
    with st.form(key="etc_form"):
        ...
        submitted = st.form_submit_button("기타사례 저장", key="etc_submit")
        if submitted:
